...
const faqs = [
{
  ...
  a: 'تواصل معنا عبر الهاتف أو البريد الإلكتروني، أو زر المركز مباشرة، وسيتولى فريقنا شرح خطوات التسجيل معك. نموذج التواصل في الصفحة الرئيسية مخصص للأسئلة والاستفسارات فقط.'
},
{
