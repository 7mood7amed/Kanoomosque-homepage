...
export const courses: Course[] = [
{
  ...
  details: {
    ...
    registration: {
      intro: [
      'انطلق في رحلة حفظ كتاب الله تعالى ضمن بيئة تربوية متكاملة، وبإشراف نخبة من المعلمين المتقنين، من خلال برنامج يعتني بتعليم القرآن الكريم، وتصحيح التلاوة، وغرس القيم الإيمانية والتربوية في نفوس الطلاب.',
      'يرجى تعبئة الاستمارة لإتمام طلب التسجيل، وسيتم مراجعة الطلب والتواصل معكم لاستكمال إجراءات القبول وتحديد المستوى.'],

      info: [
      { label: 'أيام الدوام', value: 'من الأحد إلى الخميس' },
      { label: 'وقت الدوام', value: 'من أذان المغرب إلى أذان العشاء' },
      { label: 'رسوم التسجيل', value: '20 دينارًا' },
      { label: 'الرسوم الفصلية', value: '10 دنانير لكل فصل، بواقع ثلاثة فصول خلال العام' }]
...
},
{
  ...
  details: {
    ...
    registration: {
      intro: [
      'كتاب "اقرأ وارتقِ" يعتبر دليلاً تعليمياً وتربوياً متكاملاً، صُمم خصيصاً ليكون ركيزة أساسية في بناء وتطوير مهارات اللغة العربية لدى الناشئة والمبتدئين.',
      'يستهدف الكتاب تأسيس المبتدئين لتعليم اللغة العربية على أسس علمية صحيحة منذ البداية.',
      'كذلك يستهدف طلاب المرحلة الابتدائية ولصعوبات التعلم وغير الناطقين باللغة العربية لمعالجة ضعف القراءة وتطوير مهارات النطق السليم لديهم.',
      'يعتمد الكتاب على أسلوب متدرج ومنظم يبدأ من الحروف والأساسيات ويصعد بالمتعلم خطوة بخطوة.',
      'يهدف إلى فتح آفاق القراءة الصحيحة والترتيل المتقن أمام الأطفال والمبتدئين، ليأخذ بأيديهم نحو التميز اللغوي والقرآني بأسلوب مبسط ومحبب لقلوبهم.']
