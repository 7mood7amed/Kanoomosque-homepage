      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <motion.div
            ...
            <div className="border border-silver-400/30 p-3">
              <div className="arch-full overflow-hidden border border-silver-400/20">
                <img
                  src={images.donation}
            ...
            <div className="absolute -bottom-6 start-6 end-6 border border-silver-400/35 bg-navy-900 p-5 sm:start-8 sm:end-auto sm:max-w-xs">
              <div className="flex items-center gap-3">
                <span className="arch-top flex h-12 w-11 items-center justify-center border border-silver-400/40 text-silver-200">
          ...
          <div className="pt-8 lg:pt-0">
            <span className="inline-block border-x-2 border-silver-400/50 px-4 py-1 text-xs font-bold tracking-[0.2em] text-silver-400">
              المبادرات
            </span>
            ...
            <div className="mt-8 divide-y divide-silver-400/20 border border-silver-400/30 bg-white/[0.03]">
              {tiers.map((tier, i) => {
                    ...
                    <h3>
                      <button
                        ...
                        <span className="flex items-center gap-3">
                          <span className="flex h-8 w-8 items-center justify-center border border-silver-400/40 text-silver-200">
                            {isOpen ?
                      ...
                      <motion.div
                        ...
                        className="overflow-hidden">
                          ...
                          <div className="px-5 pb-6 sm:px-6">
                            ...
                            <button
                            type="button"
                            className="mt-5 inline-flex items-center justify-center bg-pearl px-7 py-3 text-sm font-bold text-navy-900 transition-colors hover:bg-silver-200">
